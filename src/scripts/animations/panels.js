          ...
          if (proseElements.length > 0) {
            ...
            timeline.call(
              () => {
                ...
                const statsContainers = firstPanel.querySelectorAll(
                  '[data-stagger-children="true"]'
                );
              ...
              null,
              CONFIG.ANIMATION.INITIAL_PANEL_CONTENT_DELAY +
                CONFIG.ANIMATION.CONTENT_STAGGER_DELAY +
                0.2
            );
